...
var i_31318 = (0);
while(true){
if((i_31318 < arr.length)){
(arr[i_31318] = null);

var G__31319 = (i_31318 + (1));
i_31318 = G__31319;
continue;
} else {
}
...
var i_31332 = (self__.level + (1));
while(true){
if((i_31332 <= (new_level + (1)))){
(update[i_31332] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_31334 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31334[i]));
} else {
x__$2.forward.push((((i < links_31334.length))?(links_31334[i]):null));
}

if((i < links_31334.length)){
(links_31334[i] = x__$2);
} else {
links_31334.push(x__$2);
}
...
var i_31337 = (0);
while(true){
if((i_31337 <= self__.level)){
var links_31338 = (update[i_31337]).forward;
if((x__$1 === (((i_31337 < links_31338.length))?(links_31338[i_31337]):null))){
(links_31338[i_31337] = (x__$1.forward[i_31337]));

var G__31343 = (i_31337 + (1));
i_31337 = G__31343;
continue;
} else {
var G__31344 = (i_31337 + (1));
i_31337 = G__31344;
continue;
}
} else {
